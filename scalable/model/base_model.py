...
from scalable.algorithm.tree_extractor import path_extractor, assign_samples, assign_samples_lgbm, assign_distribution
...
class BaseModel():
    ...
    def generate_path(self):
        if self.model_id != -1 and os.path.exists(self.generated_path_cache):
            ...
            if self.model_name == 'random forest' or self.model_name == 'rf':
                ...
                assign_samples(self.paths, (self.X, self.y))
                assign_distribution(self.paths, (self.X_train, self.y_train))
            elif self.model_name == 'lightgbm' or self.model_name == 'lgbm':
    ...
    def get_performance(self):
        ...
        if len(self.output_labels) == 2:
            ...
            print(f'Cross entropy train: {round(cross_entropy_train, 4)}')
