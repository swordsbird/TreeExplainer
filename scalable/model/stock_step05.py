...
class Model(BaseModel):
    def __init__(self, model_name):
        ...
        if model_name == 'rf' or model_name == 'random forest':
            ...
            self.parameters = {
                'n_estimators': 680, 'learning_rate': 0.06914113189346284,
                'max_depth': 10, 'feature_fraction': 0.9161563204011132,
                'bagging_fraction': 0.62744112174829,
                'bagging_freq': 5, 'min_child_samples': 764,
    ...
    def init_data(self):
        ...
        y_train = data_table[self.target] != 'stable'
        X_test = self.test_data_table[features]
        y_test = self.test_data_table[self.target] != 'stable'
